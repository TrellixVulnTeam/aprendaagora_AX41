...
Revision ID: 68db21689d1d
Revises: fbae83f3cb08
Create Date: 2021-02-21 10:37:43.132090
...
revision = '68db21689d1d'
down_revision = 'fbae83f3cb08'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('inscricoes_feu_rosa',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('nome', sa.String(length=64), nullable=True),
    sa.Column('email', sa.String(length=32), nullable=True),
    sa.Column('numero_telefone', sa.String(length=32), nullable=True),
    sa.Column('curso', sa.String(length=16), nullable=True),
...
def downgrade():
    ...
    op.drop_table('roles')
    op.drop_table('inscricoes_feu_rosa')
    # ### end Alembic commands ###
